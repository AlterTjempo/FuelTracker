...
def get_station_detail(
    ...
    return StationDetailResponse(
        ...
        avg_e5=round(stats.avg_e5, 3) if stats.avg_e5 else None,
        avg_e10=round(stats.avg_e10, 3) if stats.avg_e10 else None,
        avg_diesel=round(stats.avg_diesel, 3) if stats.avg_diesel else None,
        min_e5=stats.min_e5,
